<template>
  <div
    ...
    id="navbar"
  >
    <a v-smooth-scroll href="#hero" class="flex justify-between w-full md:w-96"><img
    ...
    >
      <div class="ml-6 md:ml-8 text-right md:text-left">
        ...
        <p class="font-normal text-sm text-yellow-800">Ψυχολόγος - Ψυχοθεραπεύτρια παιδιού και εφήβου, οικογενειακή θεραπεύτρια</p>
      </div>
    </a>
